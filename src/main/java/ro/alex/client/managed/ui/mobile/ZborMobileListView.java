...
import ro.alex.client.managed.ui.ZborMobileListView_Roo_Gwt;
...
public class ZborMobileListView extends ZborMobileListView_Roo_Gwt {

    private static ro.alex.client.managed.ui.ZborMobileListView instance;

    public ZborMobileListView() {
        super("New Zbor", new CellRenderer());
        init();
    }

    public static ro.alex.client.managed.ui.ZborMobileListView instance() {
        if (instance == null) {
            instance = new ZborMobileListView();
        }
        return instance;
    }
    ...
    private static class CellRenderer extends AbstractSafeHtmlRenderer<ZborProxy> {
        ...
        @Override
        public SafeHtml render(ZborProxy value) {
            if (value == null) {
                return SafeHtmlUtils.EMPTY_SAFE_HTML;
            }
            SafeHtmlBuilder sb = new SafeHtmlBuilder();
            if (value.getCod() != null) {
                sb.appendEscaped(primaryRenderer.render(value.getCod()));
            }
            ...
            if (value.getData() != null) {
                sb.appendEscaped(dateRenderer.render(value.getData()));
            }
            sb.appendHtmlConstant("</div>");
            sb.appendHtmlConstant("</div>");
