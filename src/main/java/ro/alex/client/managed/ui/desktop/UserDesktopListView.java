...
import ro.alex.client.managed.ui.UserListView_Roo_Gwt;
import ro.alex.client.proxy.UserProxy;
import ro.alex.client.scaffold.place.AbstractProxyListView;

public class UserDesktopListView extends UserListView_Roo_Gwt {
    ...
    public static UserListView instance() {
        if (instance == null) {
    ...
    interface Binder extends UiBinder<HTMLPanel, UserListView> {
    }
}
