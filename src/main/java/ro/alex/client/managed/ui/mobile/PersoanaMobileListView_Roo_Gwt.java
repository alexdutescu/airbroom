...
public abstract class PersoanaMobileListView_Roo_Gwt extends MobileProxyListView<PersoanaProxy> {

    protected Set<String> paths = new HashSet<String>();

    public PersoanaMobileListView_Roo_Gwt(String buttonText, SafeHtmlRenderer<PersoanaProxy> renderer) {
