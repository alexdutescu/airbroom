...
public abstract class CompanieMobileListView_Roo_Gwt extends MobileProxyListView<CompanieProxy> {

    protected Set<String> paths = new HashSet<String>();

    public CompanieMobileListView_Roo_Gwt(String buttonText, SafeHtmlRenderer<CompanieProxy> renderer) {
