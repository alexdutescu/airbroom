...
import ro.alex.client.managed.ui.UserMobileDetailsView_Roo_Gwt;
...
public class UserMobileDetailsView extends UserMobileDetailsView_Roo_Gwt {
    ...
    private static ro.alex.client.managed.ui.UserMobileDetailsView instance;
    ...
    public static ro.alex.client.managed.ui.UserMobileDetailsView instance() {
        if (instance == null) {
