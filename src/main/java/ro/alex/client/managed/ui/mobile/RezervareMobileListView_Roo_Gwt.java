...
public abstract class RezervareMobileListView_Roo_Gwt extends MobileProxyListView<RezervareProxy> {

    protected Set<String> paths = new HashSet<String>();

    public RezervareMobileListView_Roo_Gwt(String buttonText, SafeHtmlRenderer<RezervareProxy> renderer) {
