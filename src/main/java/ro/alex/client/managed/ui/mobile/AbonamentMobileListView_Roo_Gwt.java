...
public abstract class AbonamentMobileListView_Roo_Gwt extends MobileProxyListView<AbonamentProxy> {

    protected Set<String> paths = new HashSet<String>();

    public AbonamentMobileListView_Roo_Gwt(String buttonText, SafeHtmlRenderer<AbonamentProxy> renderer) {
