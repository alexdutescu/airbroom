...
public abstract class ZborMobileListView_Roo_Gwt extends MobileProxyListView<ZborProxy> {

    protected Set<String> paths = new HashSet<String>();

    public ZborMobileListView_Roo_Gwt(String buttonText, SafeHtmlRenderer<ZborProxy> renderer) {
