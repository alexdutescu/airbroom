...
public abstract class OrasMobileListView_Roo_Gwt extends MobileProxyListView<OrasProxy> {

    protected Set<String> paths = new HashSet<String>();

    public OrasMobileListView_Roo_Gwt(String buttonText, SafeHtmlRenderer<OrasProxy> renderer) {
