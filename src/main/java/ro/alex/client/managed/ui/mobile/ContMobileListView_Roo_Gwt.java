...
public abstract class ContMobileListView_Roo_Gwt extends MobileProxyListView<ContProxy> {

    protected Set<String> paths = new HashSet<String>();

    public ContMobileListView_Roo_Gwt(String buttonText, SafeHtmlRenderer<ContProxy> renderer) {
