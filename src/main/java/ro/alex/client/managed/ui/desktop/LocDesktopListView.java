...
import ro.alex.client.managed.ui.LocListView_Roo_Gwt;
...
public class LocDesktopListView extends LocListView_Roo_Gwt {

    private static final Binder BINDER = GWT.create(Binder.class);

    private static LocListView instance;
    ...
    public static LocListView instance() {
        if (instance == null) {
            instance = new LocListView();
        }
        return instance;
    }
    ...
    interface Binder extends UiBinder<HTMLPanel, LocListView> {
    }
}
