...
import ro.alex.client.managed.activity.ClasaEditActivityWrapper.View;
...
public abstract class ClasaEditActivityWrapper_Roo_Gwt implements Activity, IsScaffoldMobileActivity {
    ...
    public interface View_Roo_Gwt<V extends ro.alex.client.managed.ui.ClasaEditView<V>> extends ClasaEditView<V> {
    }
}
