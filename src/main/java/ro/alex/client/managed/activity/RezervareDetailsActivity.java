...
public class RezervareDetailsActivity extends RezervareDetailsActivity_Roo_Gwt {

    public RezervareDetailsActivity(EntityProxyId<ro.alex.client.proxy.RezervareProxy> proxyId, ApplicationRequestFactory requests, PlaceController placeController, ProxyDetailsView<ro.alex.client.proxy.RezervareProxy> view) {
    ...
    public Place getBackButtonPlace() {
        return new ProxyListPlace(RezervareProxy.class);
    }
    ...
    public void start(AcceptsOneWidget displayIn, EventBus eventBus) {
        ...
        Receiver<EntityProxy> callback = new Receiver<EntityProxy>() {
            ...
            public void onSuccess(EntityProxy proxy) {
                ...
                view.setValue((RezervareProxy) proxy);
