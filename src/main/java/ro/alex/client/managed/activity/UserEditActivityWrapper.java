...
public class UserEditActivityWrapper extends UserEditActivityWrapper_Roo_Gwt {
    ...
    public UserEditActivityWrapper(ApplicationRequestFactory requests, View<?> view, Activity activity, EntityProxyId<ro.alex.client.proxy.UserProxy> proxyId) {
    ...
    public interface View<V extends ro.alex.client.scaffold.place.ProxyEditView<ro.alex.client.proxy.UserProxy, V>> extends ProxyEditView<UserProxy, V> {
    }
}
