...
import ro.alex.client.managed.ui.AbonamentDetailsView.Delegate;
...
public abstract class AbonamentDetailsActivity_Roo_Gwt extends AbstractActivity implements Delegate, IsScaffoldMobileActivity {

    protected ApplicationRequestFactory requests;

    protected EntityProxyId<AbonamentProxy> proxyId;

    protected PlaceController placeController;

    protected AcceptsOneWidget display;

    protected AbonamentDetailsView view;

    public void deleteClicked() {
        if (!view.confirm("Really delete this entry? You cannot undo this change.")) {
            return;
        }
        requests.abonamentRequest().remove().using(view.getValue()).fire(new Receiver<Void>() {
