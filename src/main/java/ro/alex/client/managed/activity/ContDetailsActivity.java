...
public class ContDetailsActivity extends ContDetailsActivity_Roo_Gwt {

    public ContDetailsActivity(EntityProxyId<ro.alex.client.proxy.ContProxy> proxyId, ApplicationRequestFactory requests, PlaceController placeController, ProxyDetailsView<ro.alex.client.proxy.ContProxy> view) {
    ...
    public Place getBackButtonPlace() {
        return new ProxyListPlace(ContProxy.class);
    }
