...
public class LocDetailsActivity extends LocDetailsActivity_Roo_Gwt {

    public LocDetailsActivity(EntityProxyId<ro.alex.client.proxy.LocProxy> proxyId, ApplicationRequestFactory requests, PlaceController placeController, ProxyDetailsView<ro.alex.client.proxy.LocProxy> view) {
    ...
    public Place getBackButtonPlace() {
        return new ProxyListPlace(LocProxy.class);
    }
