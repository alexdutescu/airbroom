...
import ro.alex.client.managed.activity.ContEditActivityWrapper.View;
...
public abstract class ContEditActivityWrapper_Roo_Gwt implements Activity, IsScaffoldMobileActivity {
    ...
    public interface View_Roo_Gwt<V extends ro.alex.client.managed.ui.ContEditView<V>> extends ContEditView<V> {
    }
}
