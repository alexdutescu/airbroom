...
public class UserDetailsActivity extends UserDetailsActivity_Roo_Gwt {
    ...
    public UserDetailsActivity(EntityProxyId<ro.alex.client.proxy.UserProxy> proxyId, ApplicationRequestFactory requests, PlaceController placeController, ProxyDetailsView<ro.alex.client.proxy.UserProxy> view) {
