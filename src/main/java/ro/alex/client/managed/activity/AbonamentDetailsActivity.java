...
public class AbonamentDetailsActivity extends AbonamentDetailsActivity_Roo_Gwt {

    public AbonamentDetailsActivity(EntityProxyId<ro.alex.client.proxy.AbonamentProxy> proxyId, ApplicationRequestFactory requests, PlaceController placeController, ProxyDetailsView<ro.alex.client.proxy.AbonamentProxy> view) {
    ...
    public Place getBackButtonPlace() {
        return new ProxyListPlace(AbonamentProxy.class);
    }
    ...
    public void start(AcceptsOneWidget displayIn, EventBus eventBus) {
        ...
        Receiver<EntityProxy> callback = new Receiver<EntityProxy>() {
            ...
            public void onSuccess(EntityProxy proxy) {
                ...
                view.setValue((AbonamentProxy) proxy);
