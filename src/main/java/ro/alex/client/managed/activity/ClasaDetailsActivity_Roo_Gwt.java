...
import ro.alex.client.managed.ui.ClasaDetailsView.Delegate;
...
public abstract class ClasaDetailsActivity_Roo_Gwt extends AbstractActivity implements Delegate, IsScaffoldMobileActivity {

    protected ApplicationRequestFactory requests;

    protected EntityProxyId<ClasaProxy> proxyId;

    protected PlaceController placeController;

    protected AcceptsOneWidget display;

    protected ClasaDetailsView view;

    public void deleteClicked() {
        if (!view.confirm("Really delete this entry? You cannot undo this change.")) {
            return;
        }
        requests.clasaRequest().remove().using(view.getValue()).fire(new Receiver<Void>() {
