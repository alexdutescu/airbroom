...
import ro.alex.client.managed.activity.CompanieEditActivityWrapper.View;
...
public abstract class CompanieEditActivityWrapper_Roo_Gwt implements Activity, IsScaffoldMobileActivity {
    ...
    public interface View_Roo_Gwt<V extends ro.alex.client.managed.ui.CompanieEditView<V>> extends CompanieEditView<V> {
    }
}
