...
public class ClasaDetailsActivity extends ClasaDetailsActivity_Roo_Gwt {

    public ClasaDetailsActivity(EntityProxyId<ro.alex.client.proxy.ClasaProxy> proxyId, ApplicationRequestFactory requests, PlaceController placeController, ProxyDetailsView<ro.alex.client.proxy.ClasaProxy> view) {
    ...
    public Place getBackButtonPlace() {
        return new ProxyListPlace(ClasaProxy.class);
    }
    ...
    public void start(AcceptsOneWidget displayIn, EventBus eventBus) {
        ...
        Receiver<EntityProxy> callback = new Receiver<EntityProxy>() {
            ...
            public void onSuccess(EntityProxy proxy) {
                ...
                view.setValue((ClasaProxy) proxy);
