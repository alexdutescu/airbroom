...
import ro.alex.client.managed.ui.AvionDetailsView.Delegate;
...
public abstract class AvionDetailsActivity_Roo_Gwt extends AbstractActivity implements Delegate, IsScaffoldMobileActivity {

    protected ApplicationRequestFactory requests;

    protected EntityProxyId<AvionProxy> proxyId;

    protected PlaceController placeController;

    protected AcceptsOneWidget display;

    protected AvionDetailsView view;

    public void deleteClicked() {
        if (!view.confirm("Really delete this entry? You cannot undo this change.")) {
            return;
        }
        requests.avionRequest().remove().using(view.getValue()).fire(new Receiver<Void>() {
