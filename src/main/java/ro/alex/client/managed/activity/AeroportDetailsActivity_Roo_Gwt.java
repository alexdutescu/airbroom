...
import ro.alex.client.managed.ui.AeroportDetailsView.Delegate;
...
public abstract class AeroportDetailsActivity_Roo_Gwt extends AbstractActivity implements Delegate, IsScaffoldMobileActivity {

    protected ApplicationRequestFactory requests;

    protected EntityProxyId<AeroportProxy> proxyId;

    protected PlaceController placeController;

    protected AcceptsOneWidget display;

    protected AeroportDetailsView view;

    public void deleteClicked() {
        if (!view.confirm("Really delete this entry? You cannot undo this change.")) {
            return;
        }
        requests.aeroportRequest().remove().using(view.getValue()).fire(new Receiver<Void>() {
