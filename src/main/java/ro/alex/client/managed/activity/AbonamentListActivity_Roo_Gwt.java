...
public abstract class AbonamentListActivity_Roo_Gwt extends AbstractProxyListActivity<AbonamentProxy> implements IsScaffoldMobileActivity {

    protected ApplicationRequestFactory requests;

    public AbonamentListActivity_Roo_Gwt(PlaceController placeController, ProxyListView<AbonamentProxy> view, Class<AbonamentProxy> proxyType) {
        super(placeController, view, proxyType);
    }

    protected void fireCountRequest(Receiver<Long> callback) {
        requests.abonamentRequest().countAbonaments().fire(callback);
    }
}
