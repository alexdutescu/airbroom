package ro.alex.client.scaffold.place;
 ...
 * {@link ro.alex.client.scaffold.place.Place Place}s your app can navigate to. In
 ...
 * {@link ro.alex.client.scaffold.place.ProxyListPlace ProxyListPlace}s (which show
 * all entities of a particular type) and
 * {@link ro.alex.client.scaffold.place.ProxyPlace ProxyPlace}s (which give access to
