package ro.alex.client.scaffold;

import java.util.ArrayList;
import java.util.logging.Level;
import java.util.logging.Logger;

import ro.alex.browser.BorderedLayoutWidgetContainer;
import ro.alex.browser.test.AdministrationView;
import ro.alex.client.managed.activity.ApplicationDetailsActivities;
import ro.alex.client.managed.activity.ApplicationMasterActivities;
import ro.alex.client.managed.request.ApplicationRequestFactory;
import ro.alex.client.scaffold.gae.GaeHelper;
import ro.alex.client.scaffold.place.PlaceHistoryFactory;
import ro.alex.client.scaffold.place.ProxyListPlace;
import ro.alex.client.scaffold.place.ProxyListPlacePicker;
import ro.alex.client.scaffold.place.ProxyPlaceToListPlace;
import ro.alex.client.scaffold.place.ScaffoldPlaceHistoryMapper;
import ro.alex.client.scaffold.request.RequestEvent;
...
public class ScaffoldDesktopApp extends ScaffoldApp {
	...
	private final BorderedLayoutWidgetContainer container;
	private final AdministrationView administrationView;

	@Inject
	public ScaffoldDesktopApp(AdministrationView administrationView, BorderedLayoutWidgetContainer container, ScaffoldDesktopShell shell, ApplicationRequestFactory requestFactory, EventBus eventBus, PlaceController placeController, PlaceHistoryFactory placeHistoryFactory, ApplicationMasterActivities applicationMasterActivities, ApplicationDetailsActivities applicationDetailsActivities, GaeHelper gaeHelper) {
		this.shell = shell;
