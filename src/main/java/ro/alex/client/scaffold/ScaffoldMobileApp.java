...
import ro.alex.client.managed.activity.*;
import ro.alex.client.managed.request.ApplicationRequestFactory;
import ro.alex.client.managed.ui.ApplicationListPlaceRenderer;
import ro.alex.client.scaffold.activity.IsScaffoldMobileActivity;
import ro.alex.client.scaffold.place.*;
import ro.alex.client.scaffold.gae.GaeHelper;
import ro.alex.client.style.MobileListResources;
