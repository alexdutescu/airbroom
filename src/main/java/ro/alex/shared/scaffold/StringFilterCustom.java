 ...
 */
public class StringFilterCustom<M> extends Filter<M, String> {
   ...
   */
  public StringFilterCustom(ValueProvider<? super M, String> valueProvider) {
    super(valueProvider);
  ...
  public void setFilterValue(String string){
	  ...
	  menu.setActiveItem(field, false);
  }
